    ...
    <section className="py-32 px-6" style={{ backgroundColor: '#FFFFFF' }}>
      <div className="max-w-4xl mx-auto">
        <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="space-y-8">
          <h2 className="text-4xl font-bold" style={{ color: '#1F2937' }}>Ponte en contacto con nosotros</h2>
          <p className="text-lg leading-relaxed" style={{ color: '#4B5563' }}>
            Estamos aquí para ayudarte. Contáctanos a través de nuestros canales de comunicación.
          </p>
        </motion.div>
      </div>
    </section>
...
export default function ContactanosPage() {
  useSEO({
    title: 'Pipod - Contáctanos',
    description: 'Contáctanos - Ponte en contacto con Pipod.',
    keywords: 'contacto, contáctanos, Pipod',
    ogImage: 'https://pipod.co/og-image.jpg',
    ogUrl: 'https://pipod.co/contactanos'
  });
